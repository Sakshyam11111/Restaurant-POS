...
// FULL REPLACEMENT — adds RecommendationPanel to the order sidebar
import React, { useState, useEffect } from 'react';
import { useNavigate, useLocation } from 'react-router-dom';
import toast, { Toaster } from 'react-hot-toast';
import { Search, ArrowLeft, Plus, Minus, FileText, Edit2, X } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50 overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {/* ── Right sidebar: Order + Recommendations ── */}
        <div className="w-96 bg-white border-l border-gray-200 flex flex-col flex-shrink-0">
          ...
          {/* ── Scrollable middle: Order Items + Recommendations ── */}
