...
const Printtype = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('New print type saved:', formData);
    handleHideForm();
  };

  const hasPrintTypes = false;

  return (
    <div className="min-h-screen bg-gray-50 px-6 py-6 font-sans">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-2xl font-semibold text-gray-900">Print Type</h1>
